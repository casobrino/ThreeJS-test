    ...
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]} scale={12.08}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          ...
          <mesh geometry={nodes.Object_4.geometry} material={materials.Matt_Black_Plastic} position={[0.04, 0, 0]} />
          <mesh geometry={nodes.Object_20.geometry} material={materials.Phone_color} position={[0.05, 0.14, -0.01]} rotation={[Math.PI / 2, 0, 0]} scale={1.35} />
          <mesh geometry={nodes.Object_22.geometry} material={materials.material} position={[0.05, 0.14, -0.01]} rotation={[Math.PI / 2, 0, 0]} scale={1.35} />
          <mesh geometry={nodes.Object_28.geometry} material={materials.Phone_color} position={[0.05, 0.13, 0]} scale={[1.05, 1.14, 1.14]} />
          <mesh geometry={nodes.Object_30.geometry} material={materials.Matt_Black_Plastic} position={[0.04, 0.15, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.28} />
          <mesh geometry={nodes.Object_32.geometry} material={materials.Matt_Black_Plastic} position={[0.03, 0.16, 0]} />
          <mesh geometry={nodes.Object_34.geometry} material={materials.Matt_Black_Plastic} position={[0.02, 0, 0]} scale={[0.95, 1, 0.95]} />
          <mesh geometry={nodes.Object_36.geometry} material={materials.Phone_color} position={[0.04, 0.08, 0]} scale={[0.99, 1, 1]} />
          <mesh geometry={nodes.Object_38.geometry} material={materials.Phone_color} position={[0.07, 0.1, 0]} scale={[1, 1.03, 1]} />
          <mesh geometry={nodes.Object_40.geometry} material={materials.Rubber} position={[0.04, 0.08, 0]} scale={[0.99, 1, 1]} />
          <mesh geometry={nodes.Object_45.geometry} material={materials.Phone_color} position={[0.02, 0.16, 0]} scale={[1, 1, 0.71]} />
          <mesh geometry={nodes.Object_47.geometry} material={materials.Lems} position={[0.06, 0.14, 0]} scale={0} />
          <mesh geometry={nodes.Object_49.geometry} material={materials.Lems} position={[0.06, 0.14, 0]} scale={0} />
          <mesh geometry={nodes.Object_51.geometry} material={materials.Lems} position={[0.05, 0.13, 0]} scale={0} />
          <mesh geometry={nodes.Object_53.geometry} material={materials.Lems} position={[0.05, 0.13, 0]} scale={0} />
          <mesh geometry={nodes.Object_55.geometry} material={materials.Lems} position={[0.06, 0.13, 0]} scale={0} />
          <mesh geometry={nodes.Object_57.geometry} material={materials.Lems} position={[0.06, 0.13, 0]} scale={0} />
          <mesh geometry={nodes.Object_59.geometry} material={materials.Phone_color} position={[0, 0.11, 0]} />
        </group>
      </group>
    </group>
  )
